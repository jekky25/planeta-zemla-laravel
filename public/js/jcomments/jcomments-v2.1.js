...
JComments.prototype = {
	...
	initOnReady : function(){
		if(this.isReadyInited) return;this.isReadyInited=1;var jc=this;
	...
	fade: function(id,s,e,m){
		...
		if(s>e){
			for(i=s;i>=e;i--){
				setTimeout("JComments.prototype.setOpacity('"+id+"',"+i+")",(timer*speed));timer++;
			}
